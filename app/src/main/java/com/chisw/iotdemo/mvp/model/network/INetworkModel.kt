...
interface INetworkModel{
     ...
     * Make news request
     *
     * @param callback [NetworkCallback] required
     */
    fun getNews(callback: NetworkCallback<NewsResponse>)

    /**
     * Make weather request
     *
     * @param ip [String] required
     * @param callback [NetworkCallback] required
     */
    fun getWeather(ip: String, callback: NetworkCallback<WeatherResponse>)
}